...
{
    public class FieldTreeSelectBase<TModel> : PropertyComponentBase<TModel>
    {
        [Parameter]
        ...
        public async Task Load()
        {
            ...
            var res = await httpClient.GetAsync(configuration.GetValue<string>("url") + treeSelectField.Url);
